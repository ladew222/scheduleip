...
function createResultsTable(data) {
    ...
    data.schedule.forEach(item => {
        table += `<tr><td style="border: 1px solid #ddd; padding: 8px;">${item.section}</td><td style="border: 1px solid #ddd; padding: 8px;">${item.faculty1}</td><td style="border: 1px solid #ddd; padding: 8px;">${item.timeslot}</td></tr>`;
    });
